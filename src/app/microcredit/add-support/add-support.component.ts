...
export class AddSupportComponent implements OnInit, OnDestroy {
  ...
  earnTokens(notice: { type: string, message: string }) {
    ...
    this.microcreditService.earnTokensByMerchant(this.authenticationService.currentUserValue.user["_id"], this.campaign_id, earnTokens._to, earnTokens._amount, (this.support.paid) ? 'store' : 'none', this.support.paid)
      .pipe(
        tap(
          data => {
            ...
            let message = (notice.message) ?
              notice.message + '<br>' + this.translate.instant('WIZARD_MESSAGES.SUCESS_TRANSACTION') :
              this.translate.instant('WIZARD_MESSAGES.SUCESS_TRANSACTION');
          ...
          error => {
            let message = (notice.message) ?
              notice.message + '<br> but ' + this.translate.instant('WIZARD_MESSAGES.SUCESS_TRANSACTION') :
